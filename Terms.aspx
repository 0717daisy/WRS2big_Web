                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h4 class="text-center txt-primary">Terms and Conditions</h4>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <p style="font-size:larger">
                                       ...
                                       <br /> -Republish material, 
                                        ...
                                        <br /> - Redistribute content from <strong>  '2BIG WRS Management System'     </strong>  (unless content is specifically made for redistribution). <br />
                                        <br />
                                        <strong>
                                            Disclaimer <br />
                                        </strong>
                                        ...
                                        <br /><br />Nothing in this disclaimer will: <br />

<%@ Page Title="" Language="C#" MasterPageFile="~/WRSsuperAdmin.Master" AutoEventWireup="true" CodeBehind="Subscribed.aspx.cs" Inherits="WRS2big_Web.superAdmin.Subscriptions" %>
                                                ...
                                                <div class="modal-body">
                                                 ...
                                                 <div class="x_content">
                                                  <div class="item form-group">
                                                    <div class="col-md-12 col-sm-12 ">
                                                        <asp:Label ID="Label1" runat="server" Text="Subscription Plan: "></asp:Label><br />
